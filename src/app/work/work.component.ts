import { workData } from './../user';
import { Component, OnInit } from '@angular/core';
import {UserService} from '../user.service';
import {c} from '../personal/country'
...
export class WorkComponent implements OnInit {
  ...
  public numbers:any=Array(100).fill(0).map((x,i)=>i)
  ...
  public workData:workData=new workData('',null,'',null,null,'','','','','','',null)
  ...
  validateZip(value:string)
  {
      ...
      if(this.workData.country==='India' && s.length!=6)
      {
        this.hasError=true;
      }
      else
  ...
  onClick()
  {
    this._userService.setWorkData(this.workData)
    console.log(this._userService.getWorkData())
  }
